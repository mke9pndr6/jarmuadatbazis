...
<html>
	...
	<head>
		...
		<body id = "bgStyle">
			...
			<?php
				$sql = "SELECT * FROM autokolcsonzes, felhasznalo, auto 
						WHERE autokolcsonzes.felhasznalo_nev = felhasznalo.felhasznalo_nev AND autokolcsonzes.auto_id = auto.id ORDER BY felhasznalo.felhasznalo_nev;";
				$result = mysqli_query($conn, $sql);
				$count_carrents = mysqli_num_rows($result);
				
				
				$sqlsum = "SELECT SUM(ar_osszesen) FROM autokolcsonzes;";
			...
			<div align = "center">
						...
						<div align = "center" id = "cars">
							...
							<tr>
								<td width = "15%"></td>
								<td width = "70%" align = "center" style = "padding: 10px;">Autós kölcsönzések (összesen: <?php echo $count_carrents; ?>)</td>
								<td width = "15%"></td>
							</tr>
							<tr>
						...
						<div align = "center">
							<table align = "center" width = "80%" id = "tableborders2" border = "0px" cellpadding = "0" cellspacing = "0">
								<tr>
									...
									<td width = "9%" id = "tableborders3">Autó márkája</td>
							...
							<div align = "center">
								<table align = "center" width = "80%" id = "tableborders2" border = "0px" cellpadding = "0" cellspacing = "0">
									<tr>
										...
										<td width = "9%" id = "tableborders2"> '.$row["automarka_id"].'</td>
