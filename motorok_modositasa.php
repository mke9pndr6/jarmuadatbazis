			...
			<div align = "center">
				<form method = "POST" action = "motorok_modositasa_action.php" enctype = "multipart/form-data" name = "motor_update">
					<table align = "center" width = "43.2%" id = "styleofwords" border = "0px" cellpadding = "0" cellspacing = "0">
						<tr>
							<td height = "0px"  width = "90%" id = "styleofwords2a"><font id = "styleofwords2a">Motorok módosítása</font></td>
						...
						<tr>
							...
							style="height:26px;" name = "id" size = "45" placeholder = "Adja meg a motor azonosítóját..." required /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height = "33px" id = "styleofwords9"><input type = "text" style="height:26px;" placeholder = "Újszerű/Cserélendő" name = "allapot" size = "45" required /></td>
						</tr>
						<tr>
						...
						<tr>
							<td height = "33px" id = "styleofwords7" >Hengerűrtartalom (cm3)<font id = "styleofwords8"></font></td>
						...
						<tr>
							<td height = "33px" id = "styleofwords7" >Teljesítmény (LE)<font id = "styleofwords8"></font></td>
						...
						<tr>
							...
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:25px; width: 100%;" name = "sajat_tomeg" size = "45" placeholder = "kg" required /></td>
						</tr>
						<tr>
							<td height = "33px" id = "styleofwords7" >Maximális tömeg<font id = "styleofwords8"></font></td>
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px;" name = "maximalis_tomeg" size = "45" placeholder = "kg" required /></td>
						</tr>
						<tr>
							<td height = "33px" id = "styleofwords7" >Üzemanyagtank mérete <font id = "styleofwords8"></font></td>
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px; width: 100%;" name = "tank_meret" size = "45" placeholder = "Liter" required /></td>
						</tr>
						<tr>
							<td height = "33px" id = "styleofwords7" >Átlagfogyasztás <font id = "styleofwords8"></font></td>
							<td height = "33px" id = "styleofwords9"><input type = "number" step = "0.01" style="height:26px; width: 100%;" name = "atlagfogyasztas" size = "45" placeholder = "l/100 km" required /></td>
						</tr>
						<tr>
							<td height = "33px" id = "styleofwords7" >Végsebesség <font id = "styleofwords8"></font></td>
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px; width: 100%;" name = "vegsebesseg" size = "45" placeholder = "km/h" required /></td>
						</tr>
						<tr>
							<td height = "33px" id = "styleofwords7" >Gyorsulás (1-100)<font id = "styleofwords8"></font></td>
							<td height = "33px" id = "styleofwords9"><input type = "number" step = "0.01" style="height:26px; width: 100%;" name = "gyorsulas" size = "45" placeholder = "mp" required /></td>
						</tr>
						<tr>
							<td height = "33px" id = "styleofwords7" >Munkaütem<font id = "styleofwords8"></font></td>
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px; width: 100%;" name = "munkautem" size = "45" placeholder = "2/4" required /></td>
						</tr>
						<tr>
