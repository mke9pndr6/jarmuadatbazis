				...
				<form method = "POST" action = "autok_hozzaadasa.php" enctype = "multipart/form-data" name = "car_upload">
					<table align = "center" width = "43.2%" id = "styleofwords" border = "0px" cellpadding = "0" cellspacing = "0">
						...
						<tr>
							...
							style="height:26px;" name = "marka_id" size = "45" placeholder = "pl.: 1 = Mercedes" required /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px;" name = "km_ora_allasa" size = "45" /></td>
						</tr>
						<tr>
							<td height = "33px" id = "styleofwords7" >Szállítható személyek száma<font id = "styleofwords8"/></td>
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px; width: 100%;" name = "szallithato_szemelyek" size = "45" placeholder = ""/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px; width: 100%;" name = "atlagfogyasztas" size = "45" placeholder = "" required /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height = "33px" id = "styleofwords9"><input type = "number" style="height:26px; width: 100%;" name = "gyorsulas" size = "45" placeholder = "" required /></td>
						</tr>
						<tr>
