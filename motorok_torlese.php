	...
	<head>
		...
		<body id = "bgStyle">
			...
			<?php
				...
				echo '
						<div align = "center">
							<table align = "center" width = "80.2%" id = "tableborders2" border = "0px" cellpadding = "0" cellspacing = "0">
								<tr>
									...
									<td width = "12.5%"  id = "tableborders3">Teljesítmény </td>
							...
							<div align = "center">
								<table align = "center" width = "80.2%" id = "tableborders2" border = "0px" cellpadding = "0" cellspacing = "0">
									<tr>
										...
										<td width = "12.5%" id = "tableborders2"> '.$row["motormarka_id"].'</td>
