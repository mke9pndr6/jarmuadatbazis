		...
		<body id = "bgStyle">
			...
			<div align = "center">
						...
						<div align = "center" id = "cars">
							...
							<tr>
								<td width = "15%"></td>
								<td width = "70%" align = "center" style = "padding: 10px;">Regisztrált felhasználók (összesen: <?php echo $count_carrents; ?>)</td>
								<td width = "15%"></td>
							</tr>
						</table>
					</div>
						...
						<div align = "center">
							<table align = "center" width = "90%" id = "tableborders2" border = "0px" cellpadding = "0" cellspacing = "0">
								<tr>
									...
									<td width = "8%" id = "tableborders3">Születési idő</td>
									<td width = "9%" id = "tableborders3">SZIG szám</td>
									<td width = "5%" id = "tableborders3">Ir.szám</td>
									<td width = "10%" id = "tableborders3">Város</td>
