...
<?php
	...
	if(isset($_POST['automodositasa'])){
	   ...
	   $sql = "UPDATE auto SET marka_id ='".$marka_id."', jarmutipus_id ='".$jarmutipus_id."', ar_1 ='".$ar_1."',
	   ...
	   echo '
		...
		<div align = "center">
			<table align = "center" width = "43.2%" id = "styleofwords" border = "0px" cellpadding = "0" cellspacing = "0">
				...
				<tr>
					<td height = "33px"  width = "100%" id = "styleofwords2"><font id = "styleofwords2">Autó márkája: '.$marka_tipus.'</font></td>
