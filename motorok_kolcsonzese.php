			...
			if (mysqli_num_rows($motors) > 0){
				while($row = mysqli_fetch_assoc($motors)){
					...
					?>
								...
								<form method = "post" action = "motorok_kolcsonzese_action.php" enctype = "multipart/form-data" name = "rent_a_car">
									<tr>
									...
									<tr>
										<td height = "33px" ><font color = "white" style = "padding: 1% 1% 1% 3%; font-family: Electrolize;" size = "4">Motor márkája</td>
										<td height = "33px" ><font color = "white" style = "padding: 1%;" size = "4"><?php echo $row['motormarka_id']; ?></td>
									</tr>
									...
									<tr>
										<td height = "33px" ><font color = "white" style = "padding: 1% 1% 1% 3%;" size = "4">Felhasználónév</td>
